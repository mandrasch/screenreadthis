...
<section>
	...
	<div id="result">
		...
		<div class="speechOutputContainer">
			...
			<p style="margin-top:30px;margin-bottom:0;"><small>Please note: The speech output is generated by the browser via WebSpeech API. A real screenreader software would read this differently. This speech output is just meant for demonstrational purposes of the accessibility tree, not for serious accessibility testing.</small></p>
		</div>
